...
public class piConnection {
    ...
    public void authenticateConnection(String piUser, String piPassword) throws piSessionException {
    ...
    /**
     * Retrieve all the tokens from the user
     *
     * @param user
     * @return
     * @throws piSessionException
     */
